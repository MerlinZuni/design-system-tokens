...
- [x] 06-02-PLAN.md — Storybook stories + MDX documentation for all 6 primitives with Figma embeds
- [x] 06-03-PLAN.md — Figma Code Connect .figma.tsx files + release checklist
